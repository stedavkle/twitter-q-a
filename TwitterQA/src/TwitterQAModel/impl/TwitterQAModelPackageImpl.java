...
public class TwitterQAModelPackageImpl extends EPackageImpl implements TwitterQAModelPackage {
	 ...
	 * @generated
	 */
	private EClass twitter_QAEClass = null;
	 ...
	 * @generated
	 */
	public EClass getTwitter_QA() {
		return twitter_QAEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getTwitter_QA_Games() {
		return (EReference)twitter_QAEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getTwitter_QA_Players() {
		return (EReference)twitter_QAEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getGame_Welcome_msg() {
	 ...
	 * @generated
	 */
	public EOperation getGame__Initial_test__DiagnosticChain_Map() {
	 ...
	 * @generated
	 */
	public EOperation getGame__Final_test__DiagnosticChain_Map() {
	 ...
	 * @generated
	 */
	public EAttribute getPlayer_Points() {
	 ...
	 * @generated
	 */
	public EReference getPlayer_Current_test() {
	 ...
	 * @generated
	 */
	public EAttribute getLocation_Langitude() {
	 ...
	 * @generated
	 */
	public EAttribute getTest_T_limit() {
	 ...
	 * @generated
	 */
	public EAttribute getTest_Points() {
	 ...
	 * @generated
	 */
	public EAttribute getTest_Is_initial() {
	 ...
	 * @generated
	 */
	public EAttribute getTest_Is_final() {
		return (EAttribute)testEClass.getEStructuralFeatures().get(12);
	}
	 ...
	 * @generated
	 */
	public EOperation getTest__Initial_test__DiagnosticChain_Map() {
	...
	public void createPackageContents() {
		...
		twitter_QAEClass = createEClass(TWITTER_QA);
		createEReference(twitter_QAEClass, TWITTER_QA__GAMES);
		createEReference(twitter_QAEClass, TWITTER_QA__PLAYERS);

		gameEClass = createEClass(GAME);
		createEAttribute(gameEClass, GAME__WELCOME_MSG);
		...
		createEOperation(gameEClass, GAME___INITIAL_TEST__DIAGNOSTICCHAIN_MAP);
		createEOperation(gameEClass, GAME___FINAL_TEST__DIAGNOSTICCHAIN_MAP);

		playerEClass = createEClass(PLAYER);
		createEAttribute(playerEClass, PLAYER__ID);
		createEAttribute(playerEClass, PLAYER__POINTS);
		createEReference(playerEClass, PLAYER__CURRENT_TEST);
		createEAttribute(playerEClass, PLAYER__NAME);

		locationEClass = createEClass(LOCATION);
		createEAttribute(locationEClass, LOCATION__NAME);
		createEAttribute(locationEClass, LOCATION__LANGITUDE);
		createEAttribute(locationEClass, LOCATION__LATITUDE);

		testEClass = createEClass(TEST);
		createEAttribute(testEClass, TEST__ID);
		createEAttribute(testEClass, TEST__TLIMIT);
		...
		createEAttribute(testEClass, TEST__POINTS);
		...
		createEAttribute(testEClass, TEST__IS_INITIAL);
		createEAttribute(testEClass, TEST__IS_FINAL);
		createEOperation(testEClass, TEST___INITIAL_TEST__DIAGNOSTICCHAIN_MAP);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(twitter_QAEClass, Twitter_QA.class, "Twitter_QA", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTwitter_QA_Games(), this.getGame(), null, "games", null, 0, -1, Twitter_QA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTwitter_QA_Players(), this.getPlayer(), null, "players", null, 1, -1, Twitter_QA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(gameEClass, Game.class, "Game", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getGame_Welcome_msg(), ecorePackage.getEString(), "welcome_msg", null, 1, 1, Game.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGame_Players(), this.getPlayer(), null, "players", null, 1, -1, Game.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		EOperation op = initEOperation(getGame__Initial_test__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "initial_test", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getGame__Final_test__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "final_test", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getPlayer_Id(), ecorePackage.getEString(), "id", null, 1, 1, Player.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPlayer_Points(), ecorePackage.getEInt(), "points", null, 1, 1, Player.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlayer_Current_test(), this.getTest(), null, "current_test", null, 0, 1, Player.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getLocation_Langitude(), ecorePackage.getEFloat(), "langitude", null, 1, 1, Location.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTest_T_limit(), ecorePackage.getEInt(), "t_limit", null, 1, 1, Test.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTest_Points(), ecorePackage.getEInt(), "points", null, 1, 1, Test.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTest_Is_initial(), ecorePackage.getEBoolean(), "is_initial", null, 1, 1, Test.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTest_Is_final(), ecorePackage.getEBoolean(), "is_final", null, 1, 1, Test.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getTest__Initial_test__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "initial_test", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (gameEClass,
		   source,
		   new String[] {
			   "constraints", "final_test"
		   });
		addAnnotation
		  (testEClass,
		   source,
		   new String[] {
			   "constraints", "initial_test"
		   });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (getGame__Initial_test__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "tests->one(t | t.is_initial)"
		   });
		addAnnotation
		  (getGame__Final_test__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "tests->one(t | t.is_final)"
		   });
		addAnnotation
		  (getTest__Initial_test__DiagnosticChain_Map(),
		   source,
		   new String[] {
